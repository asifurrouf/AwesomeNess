...
* [:octocat: m3u8](https://github.com/globocom/m3u8) - :star: 303 :fork_and_knife: 119 - A module for parsing m3u8 file.
...
* Productivity Tools
    ...
    * [:octocat: PathPicker](https://github.com/facebook/PathPicker) - :star: 3493 :fork_and_knife: 218 - Select files out of bash output.
...
* NoSQL Databases
    ...
    * [:octocat: HappyBase](https://github.com/wbolster/happybase) - :star: 342 :fork_and_knife: 97 - A developer-friendly library for Apache HBase.
...
* Profiler
    ...
    * [:octocat: memory_profiler](https://github.com/fabianp/memory_profiler) - :star: 1176 :fork_and_knife: 157 - Monitor Memory usage of Python code.
...
* [:octocat: wand](https://github.com/dahlia/wand) - :star: 710 :fork_and_knife: 156 - Python bindings for [MagickWand](http://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick.
...
* Archive
    * [:octocat: unp](https://github.com/mitsuhiko/unp) - :star: 280 :fork_and_knife: 37 - A command line tool that can unpack archives easily.
...
* GUI / Web Testing
    ...
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 1092 :fork_and_knife: 167 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
...
* General
    ...
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 237 :fork_and_knife: 33 - An implementation of figlet written in Python.
...
* [:octocat: python-goose](https://github.com/grangier/python-goose) - :star: 2684 :fork_and_knife: 630 - HTML Content/Article Extractor.
...
* [:octocat: RoboBrowser](https://github.com/jmcarp/robobrowser) - :star: 2871 :fork_and_knife: 228 - A simple, Pythonic library for browsing the web without a standalone web browser.
...
* [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
    * [:octocat: awesome-django](https://github.com/rosarior/awesome-django) - :star: 5990 :fork_and_knife: 1145
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 4287 :fork_and_knife: 690
* [:earth_americas: Pyramid](http://www.pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
    * [:octocat: awesome-pyramid](https://github.com/uralbash/awesome-pyramid) - :star: 368 :fork_and_knife: 40
...
* [:octocat: AutobahnPython](https://github.com/crossbario/autobahn-python) - :star: 1538 :fork_and_knife: 472 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* [:octocat: Crossbar](https://github.com/crossbario/crossbar/) - :star: 1336 :fork_and_knife: 187 - Open-source Unified Application Router (Websocket & WAMP for Python on Autobahn).
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - :star: 1049 :fork_and_knife: 216 - WebSockets for Django.
* [:octocat: WebSocket-for-Python](https://github.com/Lawouach/WebSocket-for-Python) - :star: 839 :fork_and_knife: 213 - WebSocket client and server library for Python 2 and 3 as well as PyPy.
...
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) - :star: 65337 :fork_and_knife: 8282
    * [:octocat: lists](https://github.com/jnv/lists) - :star: 4456 :fork_and_knife: 367
* Python
    * [:octocat: pycrumbs](https://github.com/kirang89/pycrumbs) - :star: 2595 :fork_and_knife: 676
    * [:octocat: python-github-projects](https://github.com/checkcheckzz/python-github-projects) - :star: 391 :fork_and_knife: 95
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) - :star: 1874 :fork_and_knife: 411
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) - :star: 565 :fork_and_knife: 122
